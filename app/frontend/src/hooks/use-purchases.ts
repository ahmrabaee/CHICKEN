...
import { PurchaseQuery, CreatePurchaseDto, UpdatePurchaseDto, ReceivePurchaseDto } from '@/types/purchases';
...
export const useUpdatePurchase = () => {
    ...
    return useMutation({
        ...
        onSuccess: (_, variables) => {
            ...
            toast({ title: 'تم تحديث أمر الشراء بنجاح' });
        },
        onError: (error: any) => {
